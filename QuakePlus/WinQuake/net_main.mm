...
#ifdef IDGODS
cvar_t	idgods = {(char*)"idgods", (char*)"0"};
#endif
...
qsocket_t *NET_NewQSocket (void)
{
	...
	strcpy (sock->address,(char*)"UNSET ADDRESS");
...
qsocket_t *NET_Connect (char *host)
{
	...
	if (host)
	{
		if (strcasecmp (host, (char*)"local") == 0)
		{
			numdrivers = 1;
			goto JustDoIt;
		}
...
vcrSendMessage_t vcrSendMessage;
