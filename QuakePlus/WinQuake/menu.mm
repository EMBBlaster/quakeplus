...
typedef enum {m_none, m_main, m_singleplayer, m_load, m_save, m_multiplayer, m_setup, m_net, m_options, m_video, m_keys, m_help, m_quit, m_serialconfig, m_modemconfig, m_lanconfig, m_gameoptions, m_search, m_slist} m_state_t;
m_state_t m_state;
...
extern	bool	gVidDisplayFullscreen;
...
static bool M_GetPasteString (int theKey, char *theString, int theStringSize)
{
    extern bool	keydown[];
...
void M_DrawTextBox (int x, int y, int width, int lines)
{
	...
	cx = x;
	cy = y;
	p = Draw_CachePic ((char*)"gfx/box_tl.lmp");
...
void M_Main_Draw (void)
{
	...
	p = Draw_CachePic ((char*)"gfx/ttl_main.lmp");
...
void M_SinglePlayer_Draw (void)
{
	...
	M_DrawTransPic (16, 4, Draw_CachePic ((char*)"gfx/qplaque.lmp") );
	p = Draw_CachePic ((char*)"gfx/ttl_sgl.lmp");
	M_DrawPic ( (320-p->width)/2, 4, p);
...
void M_Load_Draw (void)
{
	...
	p = Draw_CachePic ((char*)"gfx/p_load.lmp");
	M_DrawPic ( (320-p->width)/2, 4, p);
...
void M_Save_Draw (void)
{
	...
	p = Draw_CachePic ((char*)"gfx/p_save.lmp");
	M_DrawPic ( (320-p->width)/2, 4, p);
...
void M_MultiPlayer_Draw (void)
{
	...
	M_DrawTransPic (16, 4, Draw_CachePic ((char*)"gfx/qplaque.lmp") );
	p = Draw_CachePic ((char*)"gfx/p_multi.lmp");
	M_DrawPic ( (320-p->width)/2, 4, p);
...
void M_Net_Draw (void)
{
	...
	{
		p = Draw_CachePic ((char*)"gfx/dim_modm.lmp");
	}
	...
	{
		p = Draw_CachePic ((char*)"gfx/dim_drct.lmp");
	}
...
void M_Options_Draw (void)
{
	...
	M_DrawTransPic (16, 4, Draw_CachePic ((char*)"gfx/qplaque.lmp") );
	p = Draw_CachePic ((char*)"gfx/p_option.lmp");
	M_DrawPic ( (320-p->width)/2, 4, p);
...
void M_Keys_Draw (void)
{
	...
	p = Draw_CachePic ((char*)"gfx/ttl_cstm.lmp");
	M_DrawPic ( (320-p->width)/2, 4, p);

	if (bind_grab)
		M_Print (12, 32, (char*)"Press a key or button for this action");
	else
...
{
/* .........1.........2.... */
  (char*)"  Are you gonna quit    ",
  (char*)"  this game just like   ",
  (char*)"   everything else?     ",
  (char*)"                        ",
 
  (char*)" Milord, methinks that  ",
  (char*)"   thou art a lowly     ",
  (char*)" quitter. Is this true? ",
  (char*)"                        ",

  (char*)" Do I need to bust your ",
  (char*)"  face open for trying  ",
  (char*)"        to quit?        ",
  (char*)"                        ",

  (char*)" Man, I oughta smack you",
  (char*)"   for trying to quit!  ",
  (char*)"     Press Y to get     ",
  (char*)"      smacked out.      ",
 
  (char*)" Press Y to quit like a ",
  (char*)"   big loser in life.   ",
  (char*)"  Press N to stay proud ",
  (char*)"    and successful!     ",
 
  (char*)"   If you press Y to    ",
  (char*)"  quit, I will summon   ",
  (char*)"  Satan all over your   ",
  (char*)"      hard drive!       ",
 
  (char*)"  Um, Asmodeus dislikes ",
  (char*)" his children trying to ",
  (char*)" quit. Press Y to return",
  (char*)"   to your Tinkertoys.  ",
 
  (char*)"  If you quit now, I'll ",
  (char*)"  throw a blanket-party ",
  (char*)"   for you next time!   ",
  (char*)"                        "
};
...
void M_GameOptions_Draw (void)
{
	...
	if (rogue)
	{
		...
		{
			case 1: msg = (char*)"No Friendly Fire"; break;
			case 2: msg = (char*)"Friendly Fire"; break;
			case 3: msg = (char*)"Tag"; break;
			case 4: msg = (char*)"Capture the Flag"; break;
			case 5: msg = (char*)"One Flag CTF"; break;
			case 6: msg = (char*)"Three Team CTF"; break;
			default: msg = (char*)"Off"; break;
		}
		M_Print (160, 72, msg);
	}
	else
