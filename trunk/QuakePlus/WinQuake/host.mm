...
#ifdef QUAKE2
cvar_t	developer = {(char*)"developer",(char*)"1"};	// should be 0 for release!
#else
...
void	Host_FindMaxClients (void)
{
	...
	svs.clients = (client_s*)Hunk_AllocName (svs.maxclientslimit*sizeof(client_t), (char*)"clients");
...
//		com_argv = (char**)malloc(com_argc * sizeof(char *));
		com_argv = (char**) new char* [com_argc];
...
void Host_Init (quakeparms_t *parms)
{
	...
	if (cls.state != ca_dedicated)
	{
		host_basepal = (byte *)COM_LoadHunkFile ((char*)"gfx/palette.lmp");
		if (!host_basepal)
